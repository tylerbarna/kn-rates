...
conda activate /users/8/barna314/anaconda3/envs/simsurvey_no_gpu
...
python ZTF_sim.py --output-base results/ztf_10M_msibigmem_result --n-transients 10000000 --n-runs 20 --n-processes 10
