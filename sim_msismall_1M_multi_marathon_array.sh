...
python ZTF_sim.py --output-base results/marathon/Metzger/ztf_1M_msismall_result --n-transients 1000000 --n-runs 1 --n-processes 1 --model Metzger
...
python ZTF_sim.py --output-base results/marathon/Bu2026Vary/ztf_1M_msismall_result --n-transients 1000000 --n-runs 1 --n-processes 1 --model Bu2026Vary