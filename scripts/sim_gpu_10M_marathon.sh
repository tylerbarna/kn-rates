...
python ZTF_sim.py --output-base results/gpu_marathon/ztf_10M_msigpu_result --n-transients 10000000 --n-runs 50 --n-processes 2
# Check how many files in the results/gpu_marathon directory are under 1MB of size and print the total
find results/gpu_marathon -type f -size -1M | wc -l
